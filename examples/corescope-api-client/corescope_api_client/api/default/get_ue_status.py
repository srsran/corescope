...
from ...models.dto_ue_status import DtoUeStatus
...
def _parse_response(*, response: httpx.Response) -> Optional[DtoUeStatus]:
    if response.status_code == 200:
        response_200 = DtoUeStatus.from_dict(response.json())

        return response_200
    return None


def _build_response(*, response: httpx.Response) -> Response[DtoUeStatus]:
    return Response(
